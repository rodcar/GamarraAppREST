package pe.edu.upc.gamarra.security.jwt;

import io.jsonwebtoken.*;
import pe.edu.upc.gamarra.security.service.UserPrinciple;
...
public class JwtProvider {
    ...
    @Value("${gamarra.app.jwtSecret}")
    private String jwtSecret;

    @Value("${gamarra.app.jwtExpiration}")
